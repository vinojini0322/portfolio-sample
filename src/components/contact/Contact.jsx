				...
				<div className="contact__content">
					...
					<div className="contact__info">
						<div className="contact__card">
							...
							<span className="contact__card-data">+91 XXXXXXXXXXXXXX</span>
							<a
						...
						<div className="contact__card">
							...
							<span className="contact__card-data">XXXXXXXXXXXX@gmail.com</span>
							<a
								href="mailto:XXXXXXXXXXXX@gmail.com"
								className="contact__button">
								Write me{" "}
						...
						<div className="contact__card">
							...
							<span className="contact__card-data">
								https://www.linkedin.com/in/vinojini-paramasivam-b4748513b/
							</span>
